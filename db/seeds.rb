...
# Create Doctors
doctor_one = Doctor.create(name: "Philip Morris", photo: "https://images.pexels.com/photos/5452291/pexels-photo-5452291.jpeg?auto=compress&cs=tinysrgb&w=600", bio: "Experienced surgeon specializing in life-saving procedures. Committed to your health and well-being.", user: user_one, experience_years: "15")
doctor_two = Doctor.create(name: "Myriam Duzak", photo: "https://media.istockphoto.com/id/1189304032/photo/doctor-holding-digital-tablet-at-meeting-room.jpg?b=1&s=612x612&w=0&k=20&c=oDCtU9LmtmKYeNfzNEWCPR-Wwhe998euSNBEZFNEdxs=", bio: "Dedicated gynecologist providing comprehensive care for women's health. Compassionate and knowledgeable.", user: user_one, experience_years: "5")
doctor_three = Doctor.create(name: "Mel Gibson", photo: "https://images.pexels.com/photos/5452268/pexels-photo-5452268.jpeg?auto=compress&cs=tinysrgb&w=600", bio: "Cardiologist with expertise in heart health. Your heart's well-being is my top priority.", user: user_one, experience_years: "7")
doctor_fourth = Doctor.create(name: "Zara Tzech", photo: "https://images.pexels.com/photos/6749778/pexels-photo-6749778.jpeg?auto=compress&cs=tinysrgb&w=600", bio: "Oncologist dedicated to fighting cancer. We're in this battle together.", user: user_one, experience_years: "2")
doctor_fifth = Doctor.create(name: "Dibon Ubuntu", photo: "https://images.pexels.com/photos/4989168/pexels-photo-4989168.jpeg?auto=compress&cs=tinysrgb&w=600", bio: "Gastroenterologist committed to digestive health. Let's find your path to wellness.", user: user_one, experience_years: "4")
doctor_sixth = Doctor.create(name: "Diane Cardinal", photo: "https://images.pexels.com/photos/3714743/pexels-photo-3714743.jpeg?auto=compress&cs=tinysrgb&w=600", bio: "Pediatrician specializing in child health. Caring for your little ones with expertise and love.", user: user_one, experience_years: "6")
